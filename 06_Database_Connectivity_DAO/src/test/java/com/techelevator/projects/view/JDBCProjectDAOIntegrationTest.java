...
public class JDBCProjectDAOIntegrationTest {
	...
	@Test
	public void tests_adding_employee_to_project() {
		
		
		
		// addEmployeeToProject for an INSERT test
	...
	//@Test 
	public void tests_removing_employee_from_project() {
		
		//removeEmployeeFromProject for a DELETE test
